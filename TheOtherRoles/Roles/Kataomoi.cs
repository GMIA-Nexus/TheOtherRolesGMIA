...
namespace TheOtherRoles.Roles
{
    ...
    public class Kataomoi : RoleBase<Kataomoi>
    {
        ...
        public override GUIContext ProgressContext { get => ProgressGUI.Holder(target != null ? ProgressGUI.OneLineText(ModTranslation.getString("roleInfoKataomoiTargetFull") + ": " + (target?.Data.PlayerName ?? "")) : null); }
