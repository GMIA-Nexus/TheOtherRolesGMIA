...
| ----------------------------- | ------ | --------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| 2024.11.26s                   |        | 最新版          | [ダウンロード](https://github.com/FangkuaiYa/TheOtherRoles-GM-Haoming/releases/latest/)                                                 |
| -                             | -      | -               | -                                                                                                                                      |
...
## ヨーヨー
### **チーム：インポスター**
ヨーヨーはインポスターの1人で、ある位置をマークし、その後その位置に瞬間移動（テレポート）する能力を持っています。
最初の瞬間移動の後、ヨーヨーは自動的に最初の瞬間移動の始点に戻る前に、一定の時間（オプション）を持ち、好きなことをすることができます。
各瞬間移動の際に、透明度を設定可能な影が残ります。この影はとても見にくいものです。
設定によっては、ヨーヨーはモバイル管理者テーブルにもアクセスできる場合があります。

**注意：**
- 最初のジャンプのターゲットとなるマークされた位置は、ヨーヨーと幽霊にのみ表示されます。
- 最初の瞬間移動の影は（ほとんど）ヨーヨーが戻るまで残ります。
- 2回目の瞬間移動（戻り）の影は5秒間残ります。
