            ...
            yoyoButton = new CustomButton(
                () => {
                    ...
                    if (Yoyo.markedLocation == null)
                    {
                        ...
                        yoyoButton.buttonText = ModTranslation.getString("YoyoBlinkText");
                    }
                    else
                    {
                        // Jump to location
                        ...
                        yoyoButton.buttonText = ModTranslation.getString("YoyoReturningText");
                    }
                },
                ...
                () => {
                    ...
                    else
                    {
                        ...
                        yoyoButton.buttonText = ModTranslation.getString("YoyoMarkText");
                    }
                },
                ...
                Yoyo.blinkDuration,
                () => {
                    if (Helpers.isUsingTransportation(Yoyo.yoyo))
                    {
                ...
                buttonText: ModTranslation.getString("YoyoMarkText")
            );
