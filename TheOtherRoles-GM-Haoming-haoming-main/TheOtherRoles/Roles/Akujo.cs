...
namespace TheOtherRoles
{
    ...
    public class Akujo : RoleBase<Akujo>
    {
        ...
        public static Sprite getHonmeiSprite()
        {
            ...
            honmeiSprite = Helpers.loadSpriteFromAssetBundle("AkujoHonmeiButton.png");
            return honmeiSprite;
        }
        ...
        public static Sprite getKeepSprite()
        {
            ...
            keepSprite = Helpers.loadSpriteFromAssetBundle("AkujoKeepButton.png");
            return keepSprite;
        }
        ...
        public static void MakeButtons(HudManager hm)
        {
            ...
            honmeiButton = new CustomButton(
                ...
                () => { return PlayerControl.LocalPlayer.isRole(RoleType.Akujo) && !PlayerControl.LocalPlayer.Data.IsDead && (local.honmei == null && local.cupidHonmei == null) && local.timeLeft > 0; },
                () => { return PlayerControl.LocalPlayer.isRole(RoleType.Akujo) && !PlayerControl.LocalPlayer.Data.IsDead && local.currentTarget != null && (local.honmei == null && local.cupidHonmei == null) && local.timeLeft > 0; },
