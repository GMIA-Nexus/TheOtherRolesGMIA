...
namespace TheOtherRoles.Patches
{
    public static class UsablesPatch
    {
        ...
        public static bool IsBlocked(SystemConsole console, PlayerControl pc)
        {
            ...
            if ((isSecurity && !TORMapOptions.canUseCameras) || (isVitals && !TORMapOptions.canUseVitals)) return true;
            return false;
        }
        ...
        public static bool IsBlocked(IUsable target, PlayerControl pc)
        {
            ...
            if ((targetConsole != null && IsBlocked(targetConsole, pc)) ||
                ...
                (targetMapConsole != null && !TORMapOptions.canUseAdmin))
            {
                return true;
            }
            return false;
                    ...
                    switch (__instance.Id)
                    {
                        ...
                        case 14: // Lower Central
                            ...
                            if (canUse)
                            {
                                ...
                                canUse &= __result <= __instance.UsableDistance && (!PhysicsHelpers.AnythingBetween(@object.Collider, center, position, Constants.ShipOnlyMask, false) || __instance.name.StartsWith("JackInTheBoxVent_"));
                            }
                            return false;
                    }
                }
                ...
                if (__instance.isActiveAndEnabled && __instance.currentTarget && !__instance.isCoolingDown && PlayerControl.LocalPlayer.isAlive() && PlayerControl.LocalPlayer.CanMove)
                {
                    ...
                    if (res == MurderAttemptResult.BlankKill)
                    {
                        ...
                        if (PlayerControl.LocalPlayer == Cleaner.cleaner)
                            ...
                            PlayerControl.LocalPlayer.SetKillTimer(GameOptionsManager.Instance.currentNormalGameOptions.KillCooldown * (Mini.isGrownUp(PlayerControl.LocalPlayer) ? 0.66f : 2f));
